...
public class Objective_form{
	static String sheetName="Objective";
	keywords app;
	ExtentReports ex;
	ExtentTest test;
	WebDriver driver;
	...
	public void objectiveForm_Sanity(String LoginName,String Password,String Name,String type
										,String Hierarchy,String OwnerOrganizations,String Owners
...
//		test.log(LogStatus.INFO, "Opening form");
		...
		//form data
		app.enterValueInFormTextField("objective_name_xpath", Name);
		app.selectValueInDropdown("objective_type_xpath", type);
		app.selectValueInDropdown("objective_hierarchy_xpath", Hierarchy);
