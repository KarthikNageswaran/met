...
public class Asset_form{
	
	static String sheetName="Asset";
	keywords app;
	ExtentReports ex;
	ExtentTest test;
	WebDriver driver;
	...
	public void assetFormData(String LoginName,String Password,String Name,String Hierarchy
										,String OwnerOrganizations,String Owners
			                            ,String restrictAccessTo,String RelationshipAssetClass) throws IOException, InterruptedException{
...
//		test.log(LogStatus.INFO, "Opening form");
		...
		//form data
		app.enterValueInFormTextField("asset_name_xpath", Name);
		app.selectValueInDropdown("asset_Hierarchy_xpath", Hierarchy);
		...
		app.addRelationship(RelationshipAssetClass);
