...
public class Standard_form{
	static String sheetName="Standard";
	keywords app;
	ExtentReports ex;
	ExtentTest test;
	WebDriver driver;
	...
	public void standardData(String LoginName,String Password,String Name,String Hierarchy
										,String OwnerOrganizations,String Owners
			                            ,String restrictAccessTo,String RelationshipAOC) throws IOException, InterruptedException{
		...
		//form data
		app.enterValueInFormTextField("std_name_xpath", Name);
		app.selectValueInDropdown("std_Hierarchy_xpath", Hierarchy);
		...
		app.addRelationship(RelationshipAOC);
