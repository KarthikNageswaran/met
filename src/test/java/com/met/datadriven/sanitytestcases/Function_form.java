...
public class Function_form{
	...
	static String sheetName="Function";
	keywords app;
	ExtentReports ex;
	ExtentTest test;
	WebDriver driver;
	...
	public void functionData(String LoginName,String Password,String Name
...
//		test.log(LogStatus.INFO, "Opening form");
		...
		//form data
		app.enterValueInFormTextField("function_name_xpath", Name);
